...
struct dentry {
    ...
    dentry_t *d_parent;
    inode_t  *d_inode;
    hashmap_t *d_children; /* hashmap of children */

    int d_count;           /* reference counter */
    list_head_t d_list;    /* list of dentries */
    void *d_private;       /* implementation-specific data */

    char d_name[DENTRY_NAME_MAXLEN]; /* name of the directory */
};
